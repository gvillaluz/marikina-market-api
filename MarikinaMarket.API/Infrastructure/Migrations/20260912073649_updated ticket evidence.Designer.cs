...
namespace MarikinaMarket.API.Infrastructure.Migrations
{
    ...
    [Migration("20260912073649_updated ticket evidence")]
    partial class updatedticketevidence
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("MarikinaMarket.API.Domain.Entities.Notification", b =>
                {
                    ...
                    b.HasIndex("EnforcerId")
                        .HasDatabaseName("ix_notifications_enforcer_id");
            ...
            modelBuilder.Entity("MarikinaMarket.API.Domain.Entities.Notification", b =>
                {
                    b.HasOne("MarikinaMarket.API.Domain.Entities.User", "Enforcer")
                        ...
                        .IsRequired()
                        .HasConstraintName("fk_notifications_users_enforcer_id");
